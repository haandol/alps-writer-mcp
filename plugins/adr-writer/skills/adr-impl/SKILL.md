...
6. **Automatic Status transition (`Proposed → Accepted`)**
   ...
   For the detailed policy see `docs/adr/AGENTS.md` "Automatic transition rules". What this step triggers:
