...
- **Status always starts as `Proposed`** (`/adr-impl` switches it to `Accepted` automatically after implementation and tests). Never ask the user about promotion — see `concepts.md` "Automatic transition rules".
