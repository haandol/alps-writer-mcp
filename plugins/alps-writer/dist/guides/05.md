...
<inference_first>
Derive the minimum pages and navigation from the approved Features and Demo before asking. Treat the
questions below as a completeness checklist. Ask only when multiple user-visible designs would
materially change a Feature contract or required journey. Mark material inferred design boundaries
in the approval digest.
</inference_first>
